...
public class Technician_RepositoryIMPL implements ITechnician_Repository {
    ...
    private final String QUERY_POST_SERVICIO = "INSERT INTO SERVICIO (ID_TIPO_SERVICIO) VALUES (:ID_TIPO_SERVICIO);";
    ...
    private final String QUERY_POST_TECNICO_SERVICIO = "INSERT INTO TECNICO_SERVICIO (ID_TECNICO, ID_SERVICIO, ID_SEMANA) VALUES ( :ID_TECNICO, (SELECT MAX(ID_SERVICIO)  FROM SERVICIO), (SELECT MAX(ID_SEMANA)  FROM SEMANA) );";
    ...
    public int getTotalHoras(int dni, int n) throws Exception{
        try {
